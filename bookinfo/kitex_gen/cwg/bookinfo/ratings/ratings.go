...
type RatingResp struct {
	...
	RatingsInstance string `thrift:"RatingsInstance,2,required" frugal:"2,required,string" json:"RatingsInstance"`
}
...
func (p *RatingResp) GetRatingsInstance() (v string) {
	return p.RatingsInstance
}
func (p *RatingResp) SetRating(val int8) {
	p.Rating = val
}
func (p *RatingResp) SetRatingsInstance(val string) {
	p.RatingsInstance = val
}
...
func (p *RatingResp) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("RatingsInstance", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.RatingsInstance); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *RatingResp) DeepEqual(ano *RatingResp) bool {
	...
	if !p.Field2DeepEqual(ano.RatingsInstance) {
		return false
	}
	return true
}
...
func (p *RatingResp) Field2DeepEqual(src string) bool {

	if strings.Compare(p.RatingsInstance, src) != 0 {
		return false
	}
	return true
}
