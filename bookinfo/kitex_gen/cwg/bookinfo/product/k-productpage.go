...
func (p *Product) fastWriteField6(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "Color", thrift.STRING, 6)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.Color)
...
func (p *Product) field6Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("Color", thrift.STRING, 6)
	l += bthrift.Binary.StringLengthNocopy(p.Color)
