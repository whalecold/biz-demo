...
type Product struct {
	...
	Rating      int8   `thrift:"Rating,5,required" frugal:"5,required,i8" json:"Rating"`
	Color       string `thrift:"Color,6,required" frugal:"6,required,string" json:"Color"`
}
...
func (p *Product) GetColor() (v string) {
	return p.Color
}
...
func (p *Product) SetColor(val string) {
	p.Color = val
}
...
func (p *Product) writeField6(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("Color", thrift.STRING, 6); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *Product) DeepEqual(ano *Product) bool {
	...
	if !p.Field6DeepEqual(ano.Color) {
		return false
	}
	return true
}
...
type ListProductsResp struct {
	Items    []*Product     `thrift:"Items,1,required" frugal:"1,required,list<Product>" json:"Items"`
...
func (p *ProductPageServiceGetProductArgs) InitDefault() {
	*p = ProductPageServiceGetProductArgs{}
}
...
func (p *ProductPageServiceGetProductResult) InitDefault() {
	*p = ProductPageServiceGetProductResult{}
}
...
func (p *ProductPageServiceListProductsArgs) InitDefault() {
	*p = ProductPageServiceListProductsArgs{}
}
...
func (p *ProductPageServiceListProductsResult) InitDefault() {
	*p = ProductPageServiceListProductsResult{}
}
