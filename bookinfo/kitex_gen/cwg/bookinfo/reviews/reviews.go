...
type Review struct {
	...
	RatingsInstance string     `thrift:"RatingsInstance,4,required" frugal:"4,required,string" json:"RatingsInstance"`
}
...
func (p *Review) GetRatingsInstance() (v string) {
...
func (p *Review) SetRatingsInstance(val string) {
...
func (p *Review) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("RatingsInstance", thrift.STRING, 4); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *Review) DeepEqual(ano *Review) bool {
	...
	if !p.Field4DeepEqual(ano.RatingsInstance) {
		return false
	}
	return true
}
...
func (p *Review) Field4DeepEqual(src string) bool {
